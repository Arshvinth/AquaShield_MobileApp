...
//         console.log("✅ Image picked:", pickedUri);
...
//     formData.append("requesterName", "Arshvinth");
...
//         "http://192.168.1.116:8081/speciesRequest/addSpeciesRequest", // change to your PC’s IP
//         formData,
//         { headers: { "Content-Type": "multipart/form-data" } }
//       );
//       alert("Species Request Submitted!");
//       navigation.goBack();
//     } catch (err) {
//       console.error(err);

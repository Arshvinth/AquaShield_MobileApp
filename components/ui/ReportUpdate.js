...
import { createNewReport, getIncidentType, updateReport } from '../../src/services/reportService';
...
export default function ReportUpdateForm({ report, onBack }) {
    ...
    return (
        <>
            ...
            <KeyboardAvoidingView
                ...
                <View>
                    <Text style={styles.subTitle}>Report ID:{report._id}</Text>
                    <Text style={styles.subTitle}>Report ID:{formData.incidentInfo.incidentType}</Text>
                </View>
